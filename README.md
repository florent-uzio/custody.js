...
| ------------------- | ----------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `apiUrl`            | `string`          | -       | API URL for the API endpoints (e.g. `"https://api.metaco.8rey62.m3t4c0.services"`)                                                                                                                                                                                  |
| `authUrl`           | `string`          | -       | Authentication URL for the API endpoints (e.g. `"https://auth.metaco.8rey62.m3t4c0.services"`)                                                                                                                                                                      |
| `privateKey`        | `string`          | -       | Private key for signing requests                                                                                                                                                                                                                                    |
| `publicKey`         | `string`          | -       | Public key for authentication                                                                                                                                                                                                                                       |
| `timeout`           | `number`          | `30000` | Request timeout in milliseconds                                                                                                                                                                                                                                     |
| `apiVersion`        | `KnownAppVersion` | -       | Pin the SDK to a specific Ripple Custody backend app version. Calls that version cannot serve throw `UnsupportedInVersionError`, gated against bundled capability data (no network). Only bundled versions are accepted, and setting this skips live auto-detection |
| `autoDetectVersion` | `boolean`         | `true`  | Auto-detect the backend's capabilities from its live OpenAPI spec on the first API call (cached thereafter). Ignored when `apiVersion` is set                                                                                                                       |
| `openApiUrl`        | `string`          | -       | Override the URL the live spec is fetched from during auto-detection. Defaults to `<apiUrl>/api/OpenAPI?scope=&layout=`. Useful for non-standard instances (e.g. devboxes)                                                                                          |
| `specSource`        | `SpecSource`      | -       | Advanced: fully override how the live spec is fetched during auto-detection (e.g. custom transport/proxy, or in tests). Takes precedence over `openApiUrl`                                                                                                          |
