...
| `client.accounts`                      | `list`, `get`, `addresses`, `allDomainsAddresses`, `getAccountAddress`, `generateNewExternalAddress`, `generateNewExternalAddressDeprecated`, `getAccountBalances`, `forceUpdateAccountBalances`, `getManifests`, `getManifest`, `listComplianceConfigurations`, `getComplianceConfiguration`, `upsertComplianceConfiguration`, `findByAddress`, `findByAddressOrThrow` | `findByAddress*` search across all domains                                                        |
