...
generated by `npm run generate:custody-types` from the OpenAPI specs bundled
under `openapi/`, organized by channel (`openapi/official/`, `openapi/devbox/`).
See [ADR-0005](docs/adr/0005-official-vs-devbox-channels.md) and `CONTEXT.md`.
...
Never edit the _contents_ of the OpenAPI specs under `openapi/` (in either
`openapi/official/` or `openapi/devbox/`) — they are canonical artifacts from the
Ripple Custody server. Relocating a spec into a channel subfolder is fine;
